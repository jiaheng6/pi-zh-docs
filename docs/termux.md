...
2. 从 GitHub 或 F-Droid 安装 [Termux:API](https://github.com/termux/termux-api#installation) 以获取剪贴板和其他设备集成功能
...
- **存储访问**：要访问 `/storage/emulated/0`（下载等）中的文件，需要运行一次 `termux-setup-storage` 授予权限
