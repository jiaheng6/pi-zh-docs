...
Pi 是一个极简的终端编码工具。它的设计理念是保持核心精简，同时通过 TypeScript 扩展、技能、提示模板、主题和 Pi 包进行扩展。
...
要卸载 Pi 本身，对于 curl 和 npm 安装使用 npm：
...
- [Pi 包](packages.md) - 打包和共享扩展、技能、提示和主题。
